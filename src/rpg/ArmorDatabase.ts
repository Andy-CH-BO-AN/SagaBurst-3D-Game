...
export const ARMORS: Record<string, ArmorData> = {
  ...
  scutum_t1: {
    ...
    description: '木製的簡陋方形盾牌，勉強能抵擋一些輕微攻擊。減傷 10%。',
  },
  scutum_t2: {
    id: 'scutum_t2',
    ...
    description: '標準配發的羅馬軍團長方盾，包覆蒙皮並加固邊緣。減傷 15%。',
  },
  scutum_t3: {
    id: 'scutum_t3',
    ...
    description: '精銳百夫長配發的重型鋼鐵方盾，帶有閃耀的金色紋飾。減傷 20%。',
  },
  ...
  round_shield_t1: {
    ...
    tier: 1,
    damageReduction: 0.10,
    description: '粗糙木板拼接成的圓盾，防禦力有限。減傷 10%。',
  },
  round_shield_t2: {
    id: 'round_shield_t2',
    ...
    tier: 2,
    damageReduction: 0.15,
    description: '外圍包覆鐵環加固的維京圓盾，中央有鐵製盾凸。減傷 15%。',
  },
  round_shield_t3: {
    id: 'round_shield_t3',
